...
const DOWNLOADS = [
  { title: 'Guía Kit Lecto-Escritura',      detail: 'Guía de uso e instrucciones · 14 páginas', url: `${DL}/guia-kit-lectoescritura.pdf` },
  { title: 'Activar dos hemisferios',        detail: 'Espirales y trazos de manos · 8 páginas',  url: `${DL}/activar-dos-hemisferios.pdf` },
  ...
  return `
    <a href="${url}" style="display:block;text-decoration:none;margin-bottom:12px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td width="52" style="padding:16px 0 16px 18px;vertical-align:middle;">
            <div style="width:40px;height:40px;border-radius:50%;background:#f6d9db;
                        display:flex;align-items:center;justify-content:center;">
              <img src="${BASE}/email-icons/pdf.png" width="20" height="20" alt="" style="display:block;" />
            </div>
          </td>
          <td style="padding:16px 12px;vertical-align:middle;">
            ...
            <p style="margin:4px 0 0;font-size:12px;color:#79665b;font-family:system-ui,sans-serif;">${detail} · PDF</p>
          </td>
          ...
          <td style="padding:4px 32px 28px;">
            <a href="${CANVA_URL}" style="display:block;text-decoration:none;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td width="52" style="padding:16px 0 16px 18px;vertical-align:middle;">
                    <div style="width:40px;height:40px;border-radius:50%;background:#f6d9db;"></div>
                  </td>
                  <td style="padding:16px 12px;vertical-align:middle;">
                    ...
                    <p style="margin:4px 0 0;font-size:12px;color:#79665b;font-family:system-ui,sans-serif;">Abre directamente en Canva · Editable y reusable</p>
                  </td>
                  <td width="48" style="padding:16px 18px 16px 0;vertical-align:middle;text-align:right;">
        ...
        <tr>
          <td style="padding:20px 32px;border-top:1px solid #ead9ca;text-align:center;">
            <p style="margin:0;font-size:11px;color:#b09e96;font-family:system-ui,sans-serif;">
              Cyn · Einstein Kids · <a href="https://einsteinkids.cynponceglz.com" style="color:#b09e96;">einsteinkids.cynponceglz.com</a>
            </p>
